...
void BRc4Encrypt::replaceFourByteKey(unsigned char* fourByteKey)
{
	// ror 8
...
void BRc4Encrypt::ByteOutOfOrder(unsigned char* data)
{
...
void BRc4Encrypt::boxXorData(unsigned char* data)
{
...
void BRc4Encrypt::DeByteOutOfOrder(unsigned char* data)
{
	unsigned char ByteOut[16] = { 0 };
	ByteOut[0] = data[0];
	ByteOut[1] = data[13];
...
void BRc4Encrypt::DeboxXorData(unsigned char* data)
{
	unsigned char n_TempChang[16] = { 0 };
	// 第1个字节
